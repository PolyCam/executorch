...
build_android_native_library() {
  ...
  EXECUTORCH_VULKAN_USE_MEDIUMP_FOR_FP16="${EXECUTORCH_VULKAN_USE_MEDIUMP_FOR_FP16:-OFF}"
  ...
  cmake . -DCMAKE_INSTALL_PREFIX="${CMAKE_OUT}" \
    ...
    -DEXECUTORCH_VULKAN_USE_MEDIUMP_FOR_FP16="${EXECUTORCH_VULKAN_USE_MEDIUMP_FOR_FP16}" \
